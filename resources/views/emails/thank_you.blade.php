...
<body style="font-family:sans-serif;background:#f8f9fa;padding:24px;">
  <div style="max-width:600px;margin:auto;background:#fff;border-radius:8px;border:1px solid #e0e0e0;box-shadow:0 2px 8px #0001;">
    <div style="background:#001f4d;color:#ffd700;padding:20px 24px 10px 24px;border-radius:8px 8px 0 0;text-align:center;">
    ...
    <div style="padding:24px 24px 12px 24px;">
      ...
      <p style="font-size:16px;">Ban Tổ chức rất trân trọng sự quan tâm của Quý khách khi đã đăng ký tham dự <strong>HỘI NGHỊ QUỐC TẾ VỀ MUA BÁN VÀ SÁP NHẬP (M&A) TRONG NGÀNH Y TẾ NĂM 2025 (Lần thứ nhất)</strong> do Medicallaw tổ chức.</p>
    ...
    <div style="padding:12px 24px 24px 24px;">
        ...
        <p style="font-size:16px;">The Organizing Committee greatly appreciates your registration to attend the <strong>INTERNATIONAL CONFERENCE ON MERGERS AND ACQUISITIONS (M&A) IN THE HEALTHCARE SECTOR 2025 (1st Edition)</strong>, organized by Medicallaw.</p>
        ...
        <p style="font-size:16px;">
            ...
            <ul style="margin-left: 20px; font-size: 16px; line-height: 1.6;">
              ...
              <li><strong>Theme</strong>: <i>Legal Transparency - Medical Value</i></li>
            </ul>
        </p>
    ...
    <div style="background:#ffd700;color:#001f4d;padding:12px 24px;border-radius:0 0 8px 8px;font-size:13px; text-align: center;">
      Minh bạch pháp lý – Giá trị Y khoa | Legal Transparency - Medical Value
    </div>
  </div>
</body>
</html>
